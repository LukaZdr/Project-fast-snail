...
html.write("<body>\n\n<h1><a href='Results.html'>Manual approach results</a></h1><button id='new_index'>Reset Index</button>\n\n<table id='t' class='display'>\n<thead>\n<tr>\n<th id='f' title='Field #0'></th><th title='Field #1'>Distance measure</th><th title='Field #2'>Neighbour count</th><th title='Field #3'>Descriptor 1</th><th title='Field #4'>Descriptor 2</th><th title='Field #5'>Weight</th><th title='Field #6'>Bin count</th><th title='Field #7'>Guessing accuracy (%)</th><th title='Field #8'>Time needed (min)</th><th title='Field #9'>Image set</th>\n</tr>\n</thead>\n<tbody>\n")
