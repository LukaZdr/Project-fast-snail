...
def run(p_distance_measure, p_neighbour_count, p_descriptor_1, p_descriptor_2, p_weight, p_bin_count):   
...
#run("euklid", 8, "hog,6,8", "sobel", 0.3, 0)
#run("euklid", 8, "hog,6,8", "sobel", 0.5, 0)
#run("euklid", 8, "hog,6,8", "sobel", 0.7, 0)

run("euklid", 8, "sobel", "hog,6,8", 0.3, 0)
run("euklid", 8, "sobel", "hog,6,8", 0.5, 0)
run("euklid", 8, "sobel", "hog,6,8", 0.7, 0)

run("euklid", 4, "hog,6,8", "sobel", 0.3, 0)
run("euklid", 4, "hog,6,8", "sobel", 0.5, 0)
run("euklid", 4, "hog,6,8", "sobel", 0.7, 0)

run("euklid", 4, "sobel", "hog,6,8", 0.3, 0)
run("euklid", 4, "sobel", "hog,6,8", 0.5, 0)
run("euklid", 4, "sobel", "hog,6,8", 0.7, 0)

run("euklid", 2, "hog,6,8", "sobel", 0.3, 0)
run("euklid", 2, "hog,6,8", "sobel", 0.5, 0)
run("euklid", 2, "hog,6,8", "sobel", 0.7, 0)

run("euklid", 2, "sobel", "hog,6,8", 0.3, 0)
run("euklid", 2, "sobel", "hog,6,8", 0.5, 0)
run("euklid", 2, "sobel", "hog,6,8", 0.7, 0)
